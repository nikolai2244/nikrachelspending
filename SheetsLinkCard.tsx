      ...
      {activeTab === 'cloud' ? (
        ...
        <div className="space-y-4">
          ...
          <div
            ...
            className={`cursor-pointer p-6 border border-dashed rounded-2xl flex flex-col items-center justify-center text-center space-y-3 transition-all ${
              isDragging 
          ...
          <div className="p-3 rounded-xl bg-zinc-900/30 border border-zinc-900 text-[10px] text-zinc-500 leading-relaxed font-mono">
            💡 Gguesses layout automatically: First column as <span className="text-[#adff00]">Date</span>, then <span className="text-[#adff00]">Category</span>, then <span className="text-[#adff00]">Merchant</span>, and fourth column as <span className="text-[#adff00]">Amount</span>.
          </div>
