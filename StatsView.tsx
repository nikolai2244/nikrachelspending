...
export default function StatsView({ 
  ...
  // Initialize last 10 days with 0 to ensure beautiful coverage
  ...
  transactions
    ...
    .forEach((t) => {
      ...
      // Just track values matching our tracking dates
      if (dailyTotals[t.date] !== undefined) {
        dailyTotals[t.date] = (dailyTotals[t.date] || 0) + amt;
      } else if (last10Days.includes(t.date)) {
        dailyTotals[t.date] = amt;
      }
    });
