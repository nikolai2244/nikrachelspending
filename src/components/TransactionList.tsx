...
import { getCategoryStyle, isIncomeTransaction, isRecurringMerchant } from '../utils';
import {
  Utensils,
  Home,
  Car,
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0 pr-2">
                      ...
                      <div className="min-w-0">
                        <span className="block font-semibold text-zinc-100 text-sm truncate max-w-[150px] sm:max-w-xs">
                          {tx.merchant}
                          {isRecurringMerchant(tx.merchant) && (
                            <span className="ml-2 inline-flex items-center gap-0.5 text-[8px] uppercase tracking-wider font-bold bg-[#00e1ff]/10 text-[#00e1ff] px-1.5 py-0.5 rounded-full border border-[#00e1ff]/20 align-middle mb-0.5">
                              <RefreshCw className="w-2 h-2" /> Recurring
                            </span>
                          )}
                        </span>
